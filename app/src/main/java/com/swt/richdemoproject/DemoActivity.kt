...
import com.yuruiyin.richeditor.utils.DeviceUtil
...
class DemoActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivAddDivider = findViewById(R.id.ivAddDivider)
        ivAddImage = findViewById(R.id.ivAddImage)
        ivAddGame = findViewById(R.id.ivAddGame)
        ivAddSameImageForTest = findViewById(R.id.ivAddSameImageForTest)
        ivUndo = findViewById(R.id.ivUndo)
        ivRedo = findViewById(R.id.ivRedo)
        btnClearContent = findViewById(R.id.btnClearContent)
        btnRestoreDraft = findViewById(R.id.btnRestoreDraft)
        btnClearDraft = findViewById(R.id.btnClearDraft)
        ivBold = findViewById(R.id.ivBold)
        vgHeadline = findViewById(R.id.vgHeadline)
        ivStrikeThrough = findViewById(R.id.ivStrikeThrough)
        ivUnderline = findViewById(R.id.ivUnderline)
        ivItalic = findViewById(R.id.ivItalic)
        ivBlockquote = findViewById(R.id.ivBlockquote)
        ivHeadline = findViewById(R.id.ivHeadline)
    ...
    lateinit var ivAddDivider: ImageView
    lateinit var ivAddImage: ImageView
    lateinit var ivAddGame: ImageView
    lateinit var ivAddSameImageForTest: ImageView
    lateinit var ivUndo: ImageView
    lateinit var ivRedo: ImageView
    lateinit var btnClearContent: Button
    lateinit var btnRestoreDraft: Button
    lateinit var btnClearDraft: Button
    lateinit var ivBold: ImageView
    lateinit var vgHeadline: LinearLayout
    lateinit var ivStrikeThrough: ImageView
    lateinit var ivUnderline: ImageView
    lateinit var ivItalic: ImageView
    lateinit var ivBlockquote: ImageView
    lateinit var ivHeadline: ImageView
    lateinit var richEditText: RichEditText
    lateinit var btnSaveDraft: Button
    lateinit var btnCreateJson: Button
    lateinit var tvContentJson: TextView
    ...
    private fun initHeadline() {
        val styleBtnVm = StyleBtnVm.Builder()
            ...
            .setTitleNormalColor(ContextCompat.getColor(this, R.color.headline_normal_text_color)) // 正常标题文字颜色
            .setTitleLightColor(ContextCompat.getColor(this, R.color.headline_light_text_color))   // 高亮标题文字颜色
            .build()
...
//            handleAddSameImageForTest()
            testId = testId++
            richEditText.insertAtUser(FriendBean("你好", testId))
        }
